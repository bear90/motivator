...
<p>*В столбце «Самое выгодное предложение» стоимость горящих туров помечена символом 100€, стоимость туров при раннем бронировании помечена символом 1000.</p>
<div class="row">
    <div class="col-md-4">Вы можете выбрать интересующие вас заявки, задав параметры выбора:</div>
    <div class="col-md-4 filter" >
        <a href="#">страна тура</a><br>
        <a href="#">дата начала тура</a><br>
        <a href="#">количество взрослых туристов</a>
    </div>
