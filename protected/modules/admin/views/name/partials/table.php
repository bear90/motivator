<table class="table table-bordered text-table">
    ...
    <?php foreach ($entities as $entity):?>
        <tr>
            ...
            <td>
                <a href="<?php echo Yii::app()->createUrl("/admin/name/edit/{$entity->id}")?>" type="button" class="btn btn-default btn-xs">
                    <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> редактировать
                </a>
                <a href="<?php echo Yii::app()->createUrl("/admin/name/delete/{$entity->id}")?>" type="button" class="btn btn-danger btn-xs">
